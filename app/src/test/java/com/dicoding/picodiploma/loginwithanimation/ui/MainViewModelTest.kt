...
class MainViewModelTest {
    ...
    fun `when Get Stories Should Not Null and Return Data`() = runTest {
        ...
        Mockito.`when`(userRepository.getPagingStories("token")).thenReturn(expectedStory)

        val mainViewModel = MainViewModel(userRepository)
        val actualStory: PagingData<ListStoryItem> = mainViewModel.getPagingStories("token").getOrAwaitValue()
